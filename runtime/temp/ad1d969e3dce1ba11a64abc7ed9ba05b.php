<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpstudy_pro\WWW\tp3\public/../application/admin\view\building\edit.html";i:1566194584;s:68:"D:\phpstudy_pro\WWW\tp3\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                    ...
                    <label>楼盘户数：</label>
                        ...
                        <label>家庭面积：</label>
                        <input type="text" name="humianji" value="<?php echo $list['humianji']; ?>" class="input-xlarge">
                        <label>单价：(元)</label>
                 ...
                 <div class="tab-pane fade in" id="desc">
                            <div class="well">
                                <label>楼盘简介：</label>
                                <textarea id="editor" name="introduce" style="width:800px;" class="input-xlarge"><?php echo $list['introduce']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>活动优惠：</label>
                                <textarea name="preferential" style="width:800px;"><?php echo $list['preferential']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>公交路线：(到楼盘)</label>
                                <textarea name="traffic" style="width:800px;"><?php echo $list['traffic']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>开发商介绍：(1)</label>
                                <textarea name="kone_intro" style="width:800px;"><?php echo $list['kone_intro']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>开发商介绍：(2)</label>
                                <textarea name="ktwo_intro" style="width:800px;"><?php echo $list['ktwo_intro']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>优势介绍：(1)</label>
                                <textarea name="you_one" style="width:800px;"><?php echo $list['you_one']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>优势介绍：(2)</label>
                                <textarea name="you_two" style="width:800px;"><?php echo $list['you_two']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>优势介绍：(3)</label>
                                <textarea name="you_thre" style="width:800px;"><?php echo $list['you_thre']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>精品房源特色：</label>
                                <textarea name="fytese" style="width:800px;"><?php echo $list['fytese']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>成熟商业体系：</label>
                                <textarea name="sytixi" style="width:800px;"><?php echo $list['sytixi']; ?></textarea>
                            </div>
                            <div class="well">
                                <label>高端物业管理：</label>
                                <textarea name="wlguanli" style="width:800px;"><?php echo $list['wlguanli']; ?></textarea>
                            </div>
                </div>
                <div class="tab-pane fade in" id="attr">
                        ...
                        <div class="well">
                            ...
                            <label>关键字：</label>
                            <input type="text" name="keys" value="<?php echo $list['keys']; ?>" class="input-xlarge" style="width:1200px;">   
                            <label>400转接：</label>
                            <input type="text" name="transfer" value="<?php echo $list['transfer']; ?>" class="input-xlarge">
                        </div>
                </div>
