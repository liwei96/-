<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\phpstudy_pro\WWW\tp3\public/../application/home\view\mine\hu.html";i:1566888629;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <li class="list" data-v="<?php echo $v['id']; ?>">
            <img src="<?php echo $v['h_big']; ?>" alt="">
             <ul class="smallbox">
                ...
                <li>特点：<?php echo $v['te']; ?></li>
                <li>类型：<?php echo $v['lei']; ?></li>
